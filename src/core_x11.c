...
static qu_key key_conv(KeySym sym)
{
    ...
    case XK_KP_Insert:      return QU_KEY_KP_0;
    case XK_KP_End:         return QU_KEY_KP_1;
    case XK_KP_Down:        return QU_KEY_KP_2;
    case XK_KP_Page_Down:   return QU_KEY_KP_3;
    case XK_KP_Left:        return QU_KEY_KP_4;
    case XK_KP_Begin:       return QU_KEY_KP_5;
    case XK_KP_Right:       return QU_KEY_KP_6;
    case XK_KP_Home:        return QU_KEY_KP_7;
    case XK_KP_Up:          return QU_KEY_KP_8;
    case XK_KP_Page_Up:     return QU_KEY_KP_9;
    case XK_KP_Multiply:    return QU_KEY_KP_MUL;
    case XK_KP_Add:         return QU_KEY_KP_ADD;
    case XK_KP_Subtract:    return QU_KEY_KP_SUB;
    case XK_KP_Delete:      return QU_KEY_KP_POINT;
